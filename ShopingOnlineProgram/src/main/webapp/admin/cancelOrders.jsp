...
<table id="customers">
        ...
        try
        {
        	 Connection con=ConnectionProvided.getCon();
    	  	 ...
    	  	 ResultSet rs=st.executeQuery("select * from carte inner join product where carte.product_id=product.id and carte.orderDate is not NULL  and carte.status='Cancel'");
